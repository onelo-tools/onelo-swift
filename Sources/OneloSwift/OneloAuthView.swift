...
public struct OneloAuthView<Content: View>: View {
    ...
    public var body: some View {
        Group {
            if isAuthenticated {
                ...
                // Loading state (while fetching config / hosted URL) or retry after cancel
                ZStack {
    ...
    private func handleCode(_ code: String) async {
        ...
        do {
            ...
            // currentSession is now set — the .task above will flip isAuthenticated
        } catch {
            hostedUrl = nil
            errorMessage = error.localizedDescription
            showRetry = true
...
/// Shared WKNavigationDelegate coordinator for both platforms.
private final class WebAuthCoordinator: NSObject, WKNavigationDelegate {
    ...
    func webView(_ webView: WKWebView, didFail navigation: WKNavigation!, withError error: Error) {
        ...
        // Ignore errors caused by cancelling navigation to the callback URL
