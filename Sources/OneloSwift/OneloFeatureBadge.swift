...
/// A pill badge that renders automatically for New / Beta / Coming Soon / Greyed
/// (locked 🔒) feature statuses. Returns an empty view for all other statuses.
///
/// Usage:
...
public struct OneloFeatureBadge: View {
    ...
    private var foregroundColor: Color {
        ...
        case .greyed:       return Color(red: 0.62, green: 0.62, blue: 0.66)  // zinc-400 (locked)
    ...
    private var backgroundColor: Color {
        ...
        case .greyed:       return Color(red: 0.62, green: 0.62, blue: 0.66).opacity(0.15)
        default:            return .clear
        }
    }
}
